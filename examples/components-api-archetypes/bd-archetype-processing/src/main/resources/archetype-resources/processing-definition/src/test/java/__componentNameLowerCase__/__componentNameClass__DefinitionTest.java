...
import ${packageTalend}.processing.ProcessingFamilyDefinition;
...
public class ${componentNameClass}DefinitionTest {
     ...
     * canonical name is
     * "org.talend.components.processing.${componentNameLowerCase}.${componentNameClass}Properties"
     */
    @Test
    public void testGetPropertyClass() {
        Class<?> propertyClass = definition.getPropertyClass();
        String canonicalName = propertyClass.getCanonicalName();
        assertThat(canonicalName, equalTo("org.talend.components.processing.${componentNameLowerCase}.${componentNameClass}Properties"));
    }
