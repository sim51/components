...
import ${packageTalend}.api.component.AbstractComponentDefinition;import ${packageTalend}.api.component.ConnectorTopology;import ${packageTalend}.api.component.runtime.DependenciesReader;import ${packageTalend}.api.component.runtime.ExecutionEngine;import ${packageTalend}.api.component.runtime.JarRuntimeInfo;import ${packageTalend}.api.exception.ComponentException;import ${packageTalend}.api.properties.ComponentProperties;import ${packageTalend}.processing.ProcessingFamilyDefinition;import ${packageDaikon}.properties.property.Property;import ${packageDaikon}.runtime.RuntimeInfo;
...
public class ${componentNameClass}Definition extends AbstractComponentDefinition{
    ...
    @Override public Class<${componentNameClass}Properties> getPropertyClass() {
