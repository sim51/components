...
public class ${componentNameClass}Properties extends FixedConnectorsComponentProperties{
    ...
    * public Property<Boolean> showCountRecord = PropertyFactory.newBoolean("showCountRecord").setValue(true).setRequired();
    */
    ...
    public void refreshLayout(Form form) {
         ...
         * if (form.getName().equals(Form.MAIN)) {
            form.getWidget(showCountRecord.getValue()).setHidden(recordCount);
            }
         */
    }
